...
df.to_excel("trajectory_data_with_obstacle.xlsx", index=False, engine="openpyxl")
...
plt.savefig('vehicle_speed_error_with_obstacle.png', dpi=300, bbox_inches='tight')  # 保存为 PNG
# plt.savefig('vehicle_speed_curve.jpg', dpi=300, bbox_inches='tight')  # 保存为 JPG
...
plt.savefig('vehicle_distance_with_obstacle.png', dpi=300, bbox_inches='tight')  # 保存为 PNG
# plt.savefig('vehicle_speed_curve.jpg', dpi=300, bbox_inches='tight')  # 保存为 JPG
...
plt.savefig('vehicle_trajectories_xy_half_with_obstacle.png', dpi=300, bbox_inches='tight')
plt.show()
